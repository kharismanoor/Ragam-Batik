                ...
                <tbody>
                    @foreach ($products as $product)
                      <tr class="text-gray-700" id="myTable">
                        ...
                        <!-- Nama & Prodi -->
                        <td class="px-6 py-3 text-sm text-center">{{ $product->title }}</td>
                        <!-- Email -->
                        <td class="px-6 py-3 text-sm text-center">{{ $product->price }}</td>
        
                        <!-- Level -->
                        <td class="px-6 py-3 text-sm text-center">{{ $product->stock }}</td>
