...
<main class="p-10 sm:ml-64">
    ...
    <form class="px-6 mx-auto" action="{{ route('event.store') }}" method="post" enctype="multipart/form-data">
        @csrf
      ...
      <div class="mb-3">
        ...
        <div class="mb-4">
          <label for="date" class="block text-gray-700 font-bold mb-2">Pilih Tanggal:</label>
          <input type="date" id="date" name="date" class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
      </div>
