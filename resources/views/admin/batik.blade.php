  ...
  <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-200 border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
     <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-200">
        <ul class="space-y-2 font-medium">
           ...
           <li>
            <a href="/produk" class="flex items-center p-2 rounded-lg hover:text-black hover:bg-yellow-600 group">
      ...
      <li>
        <a href="/batik" class="flex items-center p-2 rounded-lg text-white bg-yellow-600 group">
                  ...
                  <table class="w-full min-w-full stripe hover" id="example">
                    <thead>
                      ...
                      > 
                        ...
                        <th class="px-6 py-3 text-center">Asal</th>
                ...
                <tbody>
                    @foreach ($batiks as $batik)
                      <tr class="text-gray-700" id="myTable">
                        <!-- Nomer -->
                        <td class="px-6 py-3 text-sm text-center">{{ $batik->id }}</td>
                        <!-- Nama -->
                        <td class="px-6 py-3 text-sm text-center">{{ $batik->nama_batik }}</td>
                        <!--Asal -->
                        <td class="px-6 py-3 text-sm text-center">{{ $batik->asal }}</td>
    
                      
        
                        <!-- Aksi -->
                        <td class="px-4 py-3 text-xs text-center">
                          <form  action="{{ route('batik.destroy', $batik->id) }}" method="POST">
                          <a
                          href="{{ route('batik.edit', $batik->id) }}"
