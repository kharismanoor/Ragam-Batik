...
<nav class="fixed top-0 z-50 w-full bg-red-900 border-b border-gray-200">
  ...
  <main class="p-10 sm:ml-64">
    ...
    <form class="px-6 mx-auto" action="{{ route('batik.update', $batiks->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Foto Profil -->
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input
          ...
          id="nama_batik"
          name="nama_batik"
          value="{{ old('nama_batik', $batiks->nama_batik) }}"
    ...
    @enderror
      ...
      <div class="mb-3">
        ...
        <input
          ...
          id="history"
          name="history"
          value="{{ old('history', $batiks->history) }}"
