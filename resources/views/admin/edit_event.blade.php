...
<nav class="fixed top-0 z-50 w-full bg-red-900 border-b border-gray-200">
  ...
  <main class="p-10 sm:ml-64">
    ...
    <form class="px-6 mx-auto" action="{{ route('event.update', $events->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
      ...
      <div class="mb-3">
        ...
        <input
          ...
          id="pelaksanaan"
          name="pelaksanaan"
          value="{{ old('pelaksanaan', $events->pelaksanaan) }}"
    ...
    @enderror
      ...
      <div class="mb-3">
        ...
        <input
          ...
          id="lokasi"
          name="lokasi"
          value="{{ old('lokasi', $events->lokasi) }}"
